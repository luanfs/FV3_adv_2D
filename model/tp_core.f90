...
666   continue
 ...
 real(R_GRID), INTENT(IN) :: q(ifirst:ilast,jsd:jed)
 real(R_GRID), intent(in) :: c(isd:ied,js:je+1 )  ! Courant number
 real(R_GRID), INTENT(OUT):: flux(ifirst:ilast,js:je+1)   !  Flux
 real(R_GRID), intent(IN) :: lim_fac
! Local:
